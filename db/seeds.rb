...
items_with_images = {
  ...
  'meat' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1697543622/Better%20Shopper/stew_meat.jpg',
  ...
  'apple' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1697543619/Better%20Shopper/red_apple.jpg',
  ...
  'pepper' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1697543614/Better%20Shopper/pack_pepper.jpg',
  ...
  'chicken' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1697543607/Better%20Shopper/chicken_thigh.jpg',
  'tomato' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1697543606/Better%20Shopper/cherry_tomato.jpg',
  ...
  'cheese' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1698228419/Better%20Shopper/cheese.png',
  'rice' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1698228419/Better%20Shopper/rice.png',
  'flour' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1698228419/Better%20Shopper/flour.png',
  'sugar' => 'https://res.cloudinary.com/dw4vy98yd/image/upload/v1698228418/Better%20Shopper/sugar.jpg'
}
...
items_with_images.each do |item_name, image_url|
  stores.each do |store|
    item = Item.create!(name: item_name, image_url: image_url, store: store, unit_price: rand(1.0..3.5).round(2))
    puts "Created #{item_name}, #{store.name}, #{item.unit_price}"
  end
end
